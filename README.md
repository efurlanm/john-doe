...
The template contains an example of a website that has external links that appear with an arrow on the right side indicating an external link that can only be viewed in a browser with Internet access.
